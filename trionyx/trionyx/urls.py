...
urlpatterns = [
    ...
    path('model/<str:app>/<str:model>/<int:pk>/<str:code>/', core_views.LayoutView.as_view(), name='model-view-custom'),
    ...
    path('dialog/model/<str:app>/<str:model>/<int:pk>/<str:code>/', core_views.LayoutDialog.as_view(), name='model-dialog-view'),
