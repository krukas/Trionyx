# Generated by Django 2.2.6 on 2019-10-24 11:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('trionyx', '0008_auditlogentry_object_verbose_name'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='log',
            name='file_line',
            field=models.IntegerField(verbose_name='File line'),
        ),
        migrations.AlterField(
            model_name='log',
            name='file_path',
            field=models.CharField(max_length=256, verbose_name='File path'),
        ),
        migrations.AlterField(
            model_name='log',
            name='last_event',
            field=models.DateTimeField(verbose_name='Last event'),
        ),
        migrations.AlterField(
            model_name='log',
            name='level',
            field=models.IntegerField(choices=[(50, 'Critical'), (40, 'Error'), (30, 'Warning'), (20, 'Info'), (10, 'Debug'), (0, 'Not set')], verbose_name='Level'),
        ),
        migrations.AlterField(
            model_name='log',
            name='log_count',
            field=models.IntegerField(default=1, verbose_name='Log count'),
        ),
        migrations.AlterField(
            model_name='log',
            name='log_hash',
            field=models.CharField(max_length=32, verbose_name='Log hash'),
        ),
        migrations.AlterField(
            model_name='log',
            name='message',
        ...
        migrations.AlterField(
            model_name='user',
            name='avatar',
            field=models.ImageField(blank=True, default='', upload_to='avatars/', verbose_name='Avatar'),
        ),
        migrations.AlterField(
            model_name='user',
            name='created_at',
        ...
        migrations.AlterField(
            model_name='user',
            name='last_online',
            field=models.DateTimeField(blank=None, null=True, verbose_name='Last online'),
        ),
        migrations.AlterField(
            model_name='user',
            name='updated_at',
